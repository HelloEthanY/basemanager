<template>
    <div class="gank-android-container" id="android-content" v-loading="loading"
    ...
    export default {
        ...
        methods: {
            ...
            loadingData() {
                let _this = this;
                _this.loading = true;
                /*let type = _this.$route.params;
                if (type.type === undefined) {
                    return;
                }*/
                ++_this.page;
                _this.$axios.get('http://gank.io/api/data/Android/10/' + _this.page).then(response => {
            ...
            load() {
                this.loadingData();
                /*let androidContent = document.getElementById("android-content");
                if (androidContent != null) {
                    let scrollHeight = androidContent.scrollHeight;
                    let scrollTop = androidContent.scrollTop;
                    let clientHeight = androidContent.clientHeight;
